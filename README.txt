This folder contains 2 Python files. Each Python file corresponds to an assignment.
...
However, you'll have to rewrite the assignments in your preferred language and add instructions on how to execute the programs.
